...
android {
    ...
    defaultConfig {
        applicationId = "com.lyo.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"

        buildConfigField("String", "API_BASE_URL", "\"https://api.lyoai.app/\"")
    }
...
dependencies {
    ...
    // Screen state that survives opening a detail page (Community map, filters).
