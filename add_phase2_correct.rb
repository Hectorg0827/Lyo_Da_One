...
files_to_add = [
  'Sources/Core/AppUIState.swift',
  'Sources/Components/AITutor/LioOrbView.swift',
  'Sources/Services/LioChatService.swift',
  'Sources/Views/Main/AITutor/LioChatSheet.swift'
]
