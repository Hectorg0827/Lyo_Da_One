...
// MARK: - Classroom Scene Models (scene_start / scene_update / scene_complete)

/// Payload for scene-based classroom events from the backend.
/// Matches: `{ "scene_id": "...", "scene_type": "instruction", "components": [...], "metadata": {...} }`
...
/// Backend sends typed components: TeacherMessage, CTAButton, CodeSnippet, QuizMCQ, etc.
struct SceneComponent: Codable, Identifiable {
    let componentId: String
    let type: String               // "TeacherMessage", "CTAButton", "CodeSnippet", etc.
...
extension SceneComponent {
    /// Convert a backend scene component into a LiveLessonBlock.
    func toLessonBlock() -> LiveLessonBlock {
        ...
        default:
            // Fallback: render as a styled paragraph
            return LiveLessonBlock(
                id: componentId,
                type: .paragraph,
                title: type,
...
extension ClassroomScenePayload {
    /// Convert all components in this scene to LiveLessonBlocks.
