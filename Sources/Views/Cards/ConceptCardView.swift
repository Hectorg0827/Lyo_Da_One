...
struct AnimatedMeshBackground: View {
    ...
    var color1: Color { Color(hex: palette.color1Hex) }
    var color2: Color { Color(hex: palette.color2Hex) }
    var color3: Color { Color(hex: palette.color3Hex) }
...
// NOTE: FlowLayout is defined in Sources/Components/Common/FlowLayout.swift
// NOTE: Color init(hex:) is defined in Sources/Core/DesignTokens.swift
